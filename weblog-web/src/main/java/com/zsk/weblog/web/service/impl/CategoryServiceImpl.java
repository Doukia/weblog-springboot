...
import com.zsk.weblog.web.model.vo.category.FindCategoryArticlePageListRspVO;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public Response findCategoryArticlePageList(FindCategoryArticlePageListReqVO findCategoryArticlePageListReqVO) {
        ...
        List<Long> articleIds
                = articleCategoryRelDOS.stream().map(ArticleCategoryRelDO::getArticleId).collect(Collectors.toList());
